...
public class Employee implements Person{
	...
	private BigDecimal salary;			//DONT KNOW IF ITS STRING
	
	// dont know if there's a constructor or not
	public Employee(String id, String f, String l, BigDecimal s) {
		ID = id;
		firstName = f;
		lastName = l;
		salary = s;		
	...
	public static Person parse(String info) throws Exception {
		String[] infos = info.split(",");
		Employee person = new Employee(infos[0],infos[1],infos[2],new BigDecimal(infos[3]));
		return person; 	// upcasting the employee object to type Person
	}
